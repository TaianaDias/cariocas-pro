...
const STATUS_MAP: Record<StatusBadgeStatus, { label: string; cor: string; bg: string }> = {
  critico: { label: "🚨 Crítico", cor: "var(--crimson)", bg: "rgba(220, 38, 38, 0.12)" },
  vencimento: { label: "⏳ Vencimento", cor: "var(--yellow-warn)", bg: "rgba(234, 179, 8, 0.12)" },
  aumento_custo: { label: "💸 Aumento de Custo", cor: "var(--yellow-warn)", bg: "rgba(234, 179, 8, 0.15)" },
  ...
  pausado: { label: "⏸️ Pausado", cor: "var(--text-soft)", bg: "rgba(107, 114, 128, 0.15)" },
};
