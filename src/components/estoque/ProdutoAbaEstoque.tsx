  ...
  return (
    <section className="drawer-tab">
      ...
      <div className="drawer-form-grid">
        ...
        <TextInput label="Estoque mínimo" type="number" min="0" value={produto.estoqueMinimo ?? 0} onChange={(event) => onChange({ estoqueMinimo: numberValue(event.target.value) })} />
        <TextInput label="Estoque máximo" type="number" min="0" value={produto.estoqueMaximo ?? 0} onChange={(event) => onChange({ estoqueMaximo: numberValue(event.target.value) })} />
